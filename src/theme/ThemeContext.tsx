...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  // Debug logging
  console.log('ThemeContext - colorScheme:', colorScheme);
  console.log('ThemeContext - theme background:', theme.colors.background);
  console.log('ThemeContext - gradients:', theme.gradients);
